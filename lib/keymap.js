...
module.exports = function (CodeMirror) {
  var defaultKeymap = [];
  var _defaultKeymap = [// Key to key mapping. This goes first to make it possible to override
  // existing mappings.
  {
    keys: '<Left>',
    type: 'keyToKey',
  ...
  var Vim = function () {
    ...
    var vimApi = {
      ...
      cmKeyToVimKey: cmKeyToVimKey // Represents the current input state.
    ...
    * match the input selection.
    ...
    var actions = {
      ...
      enterInsertMode: function (cm, actionArgs, vim) {
        ...
        logger.debug('enter insert mode!', actionArgs, vim.visualMode);
    ...
    */
    ...
    CodeMirror.keyMap.vim = {
      attach: attachVimMap,
      detach: detachVimMap // call: cmKey
