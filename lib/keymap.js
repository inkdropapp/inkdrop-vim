    ...
    * in the right place.
    ...
    var exCommands = {
      ...
      sort: function (cm, params) {
        ...
        var numberRegex = pattern || number == 'decimal' ? /(-?)([\d]+)/ : number == 'hex' ? /(-?)(?:0x)?([0-9a-f]+)/i : number == 'octal' ? /([0-7]+)/ : null;
