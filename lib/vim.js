...
class Plugin {
  ...
  registerCommands() {
    ...
    const wrapper = cm.getWrapperElement(); // bind key to command
    ...
    const p = command => {
      return e => {
        _inkdrop.logger.debug('operator command:', command, 'state:', Object.assign({}, cm.state.vim.inputState), e.originalEvent);
